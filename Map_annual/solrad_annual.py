...
df1.rename(columns={'solrad_annual':'연간 태양 입사량(kWh/m2/day)'},inplace=True)
px.set_mapbox_access_token(open("mapbox_token.py").read()) # you will need your own token

fig = px.scatter_mapbox(df1, lat="lat", lon="lng", color='연간 태양 입사량(kWh/m2/day)',hover_name="주소",hover_data=["연간 태양 입사량(kWh/m2/day)","노선명"],
